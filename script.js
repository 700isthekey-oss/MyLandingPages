const products = {
  ...
  "ballet-skirt-dust-pink": { category: "Skirts", name: "BALLET SKIRT DUST PINK", price: 92000, image: "assets/products/ballet-skirt.png?v=b95d6a6", description: "Light pink wrap silhouette", detail: "더스트 핑크 컬러의 가벼운 랩 실루엣 스커트입니다.", sizes: ["S", "M", "L"] },
  "mesh-wrap-pink": { category: "Skirts", name: "MESH WRAP PINK", price: 88000, image: "assets/products/mesh-wrap-skirt.png?v=b95d6a6", description: "Sheer pink layered mesh", detail: "핑크 톤의 레이어드 메쉬 랩 스커트입니다.", sizes: ["S", "M", "L"] },
  "chiffon-midi-blush": { category: "Skirts", name: "CHIFFON MIDI BLUSH", price: 108000, image: "assets/products/chiffon-midi-skirt.png?v=b95d6a6", description: "Soft blush city-length skirt", detail: "블러시 핑크 톤의 미디 기장 쉬폰 스커트입니다.", sizes: ["S", "M", "L"] },
  "dust-pink-skirt": { category: "Skirts", name: "DUST PINK SKIRT", price: 96000, image: "assets/products/dust-pink-skirt.png?v=b95d6a6", description: "Soft ballet pink tone", detail: "ETOILE의 더스트 핑크 무드를 담은 발레 스커트입니다.", sizes: ["S", "M", "L"] },

  "ballet-shorts-black": { category: "Ballet Shorts", name: "BALLET SHORTS BLACK", price: 86000, image: "assets/products/ballet-shorts.png?v=b95d6a6", description: "Black high-rise training shorts", detail: "블랙 컬러의 하이라이즈 발레 트레이닝 쇼츠입니다.", sizes: ["S", "M", "L"] },
  "cross-waist-black": { category: "Ballet Shorts", name: "CROSS WAIST BLACK", price: 89000, image: "assets/products/cross-waist-shorts.png?v=b95d6a6", description: "Black sculpted waist detail", detail: "블랙 컬러의 크로스 웨이스트 쇼츠입니다.", sizes: ["S", "M", "L"] },
  "modal-studio-black": { category: "Ballet Shorts", name: "MODAL STUDIO BLACK", price: 82000, image: "assets/products/modal-studio-shorts.png?v=b95d6a6", description: "Black soft modal touch", detail: "블랙 모달 소재로 만든 데일리 스튜디오 쇼츠입니다.", sizes: ["S", "M", "L"] },
  "pocket-training-black": { category: "Ballet Shorts", name: "POCKET TRAINING BLACK", price: 94000, image: "assets/products/pocket-training-shorts.png?v=b95d6a6", description: "Black daily pocket design", detail: "블랙 컬러의 포켓 디테일 트레이닝 쇼츠입니다.", sizes: ["S", "M", "L"] },
